...
public class AppiumUtils {
    ...
    private PageObjectRepoHelper.PLATFORM platform;
    ...
    public AppiumUtils(AppiumDriver driver, String pageObjectRepoFileName, PageObjectRepoHelper.PLATFORM platform) {
        this.driver = driver;
...
//    }
    ...
    public void pressDeviceHomeButton() {
        ...
        } else if (platform == PageObjectRepoHelper.PLATFORM.ANDROID) {
...
//        WebElement element = waitForElementToDisplay(locatorName);
    ...
    * */
    public PageObjectRepoHelper.PLATFORM getPlatform() {
        return platform;
    }
