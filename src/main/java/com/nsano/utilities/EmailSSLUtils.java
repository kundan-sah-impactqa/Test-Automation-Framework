...
import static com.nsano.base.BaseTestWebClassContext.end;
import static com.nsano.base.BaseTestWebClassContext.start;
...
//            messageBodyPart.setText(str);
     ...
     * @return
     */
    public String prepareHTMLMessage(String lapsedTime, int totalTests, int testPassed, int testFailed,
                                     int testSkipped) {
        ...
        strbResult.append(
                "<table id=\"footer\" align=\"center\" style=\"border: 0;width: 100%;vertical-align: bottom;\"><tr><td style=\"border: 0;text-align: center;\"><i> **** This is an auto generated email from the QA Test Automation Suite. Please do not respond. **** </i></td></tr></table>");
        ...
        strbResult.append("<b>Environment</b>: " + FrameworkConfig.getStringConfigProperty("ApplicationURL_QA") + "<br>");
        strbResult.append("<b>Test Automation Suite</b>: " + "Regression" + "<br>");
        String hostName = SystemUtils.getHostName();
        strbResult.append("<b>Hostname</b>: " + hostName + "<br>");
        strbResult.append("<b>Test Cases Executed</b>: " + totalTests + "<br>");
        String osType = System.getProperty("os.name");
        strbResult.append("<b>Operating System</b>: " + osType + "<br>");
        strbResult.append("<b>Start Time (UTC)</b>: " + start + "<br>");
        strbResult.append("<b>End Time (UTC)</b>: " + end + "<br>");
        strbResult.append("<b>Execution Time</b>: " + lapsedTime + "<br>");
        ...
        strbResult.append("</td>");
        strbResult.append("<td align=\"center\" colspan=\"6\"><p><b>Total Test Cases Executed<br><br>" + totalTests
                + "</b></p></td>");
        strbResult.append("</tr>");
        strbResult.append("<tr><td colspan=\"2\">Passed Test Case Count</td><td colspan=\"1\" align=\"center\">"
                + testPassed + "</td><td colspan=\"2\">Passed Test Case %</td><td colspan=\"1\" align=\"center\">"
                + (new DecimalFormat("#.##")).format(((float) testPassed * 100) / (float) totalTests) + "%</td></tr>");
        strbResult.append("<tr><td colspan=\"2\">Failed Test Case Count</td><td colspan=\"1\" align=\"center\">"
                + testFailed + "</td><td colspan=\"2\">Failed Test Case %</td><td colspan=\"1\" align=\"center\">"
                + (new DecimalFormat("#.##")).format(((float) testFailed * 100) / (float) totalTests) + "%</td></tr>");
        strbResult.append("<tr><td colspan=\"2\">Skipped Test Case Count</td><td colspan=\"1\" align=\"center\">"
                + testSkipped + "</td><td colspan=\"2\">Skipped Test Case %</td><td colspan=\"1\" align=\"center\">"
