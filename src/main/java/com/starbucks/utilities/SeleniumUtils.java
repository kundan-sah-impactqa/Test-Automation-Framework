...
import com.starbucks.utilities.PageObjectRepoHelper.PLATFORM;
...
public class SeleniumUtils {
    ...
    public void waitForLoader(WebDriver driver, List<WebElement> Loader, int timeInSecs) {
        if (Loader != null) {
            try {
                ...
                driver.manage().timeouts().implicitlyWait(BasePage.implicitWaitSec, TimeUnit.SECONDS);
            }
        }
    }
    ...
    public void waitForLoader() {
        this.waitForLoader(BasePage.maxWaitTimeInSec);
    }
