...
import com.starbucks.exceptions.CustomRunTimeException;
...
public class FrameworkConfig extends CommonUtil {
    ...
    private static final String envProperties = SystemUtils.PROJECT_DIRECTORY + SystemUtils.FILE_SEPARATOR + "src"+ SystemUtils.FILE_SEPARATOR +"test"+ SystemUtils.FILE_SEPARATOR +"resources"+ SystemUtils.FILE_SEPARATOR +"config.properties";
